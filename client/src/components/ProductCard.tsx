...
import optimize from "next/dist/server/optimize-amp";
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex items-center gap-4 text-xs ">
                    ...
                    <div className="flex flex-col gap-1 "> 
                        ...
                        <select name="size" id="size" className="ring ring-gray-500 rounded-md px-2 py-1"
                        onChange={(e)=>{
                        ...
                        <div className="flex items-center gap-2">
                            {
                                product.colors.map(color=>(
                                    <div className={`cursor-pointer border-1 ${productTypes.color === color ? "border-gray-400" : "border-gray-200"} rounded-full p-[1.2]`} key={color} onClick={()=> handleProductType({type: "color", value:color})}>
